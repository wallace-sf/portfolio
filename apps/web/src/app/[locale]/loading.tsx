...
export default async function HomeLoading() {
  ...
  return (
    <div className="animate-pulse" aria-busy="true" aria-label={t('loading')}>
      {/* HeroBanner — bg-surface, xl:h-[424px], two columns */}
      <section className="flex flex-col bg-surface gap-y-6 xl:flex xl:flex-row xl:rounded-xl xl:h-106">
      ...
      <section className="flex flex-col gap-x-6 xl:flex-row mx-4 xl:mx-auto xl:w-full xl:max-w-237.5">
        <div className="flex flex-col flex-1 gap-y-4 bg-surface p-6 rounded-xl mb-4 xl:mb-0">
          <div className="h-6 w-36 bg-gray-700 rounded" />
          <div className="h-32 bg-gray-700 rounded" />
          <div className="h-10 w-24 bg-gray-700 rounded self-end" />
        </div>
        <div className="flex flex-col gap-y-3 bg-surface px-4 py-6 rounded-xl xl:w-72">
