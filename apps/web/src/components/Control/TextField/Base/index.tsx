      ...
      className={classNames(
        {
          ...
          'border-2 border-dark-500 bg-dark-300 h-12 rounded-xl p-3 w-full text-sm font-medium outline-none placeholder:font-normal focus:!border-primary active:!border-primary placeholder:text-gray-300 disabled:bg-whiter disabled:cursor-default dark:text-white':
            !unstyled,
        },
        props.className,
      )}
