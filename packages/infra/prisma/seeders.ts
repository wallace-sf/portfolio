...
export async function seedProfile(db: PrismaClient): Promise<void> {
  await db.profile.upsert({
    ...
    update: {
      ...
      bio: loc(
        "I'm a Frontend Engineer with over 6 years of experience specialized in React, Next.js, TypeScript, and front-end architecture, focused on building maintainable, accessible, and production-ready web applications — especially projects involving complex UI state, design systems, API integrations, and clear architectural boundaries.\n\nOver the past few years, I've worked on B2B platforms, embeddable widgets, Shopify apps, AI-powered interfaces, dynamic survey builders, and real-time workflow integrations. My work includes a B2B e-commerce platform with ~2,000 SKUs, an AI chatbot widget connected to a network of 800+ golf course clients, a survey builder rewrite delivered in three weeks, and a public technical portfolio with ~100 test files, 88 WCAG issues resolved, three-language internationalization, technical SEO, and Clean Architecture/DDD concepts.\n\nPassionate about product-oriented environments, I focus on architecture, UX, and quality to deliver impactful results.\n\nCurrently seeking international Front-end Engineering opportunities where I can contribute with React/Next.js, TypeScript, architecture, product thinking, and high-quality execution — especially with remote teams building reliable, scalable, and user-focused web products.",
        'Sou Engenheiro Frontend com mais de 6 anos de experiência especializado em React, Next.js, TypeScript e arquitetura frontend, focado em construir aplicações web sustentáveis, acessíveis e prontas para produção — especialmente projetos que envolvem estado de UI complexo, design systems, integrações de API e limites arquiteturais claros.\n\nNos últimos anos, trabalhei com plataformas B2B, widgets incorporáveis, apps Shopify, interfaces com IA, construtores de pesquisas dinâmicos e integrações de workflow em tempo real. Meu trabalho inclui uma plataforma B2B de e-commerce com ~2.000 SKUs, um widget de chatbot de IA conectado a uma rede de mais de 800 clientes de campos de golfe, a reescrita de um survey builder entregue em três semanas, e um portfólio técnico público com ~100 arquivos de teste, 88 problemas de WCAG resolvidos, internacionalização em três idiomas, SEO técnico e conceitos de Clean Architecture/DDD.\n\nApaixonado por ambientes orientados a produto, foco em arquitetura, UX e qualidade para entregar resultados de impacto.\n\nAtualmente em busca de oportunidades internacionais como Engenheiro Frontend, onde possa contribuir com React/Next.js, TypeScript, arquitetura, visão de produto e execução de alta qualidade — especialmente em times remotos construindo produtos web confiáveis, escaláveis e centrados no usuário.',
        'Soy Ingeniero Frontend con más de 6 años de experiencia especializado en React, Next.js, TypeScript y arquitectura frontend, enfocado en construir aplicaciones web mantenibles, accesibles y listas para producción — especialmente proyectos que involucran estado de UI complejo, design systems, integraciones de API y límites arquitectónicos claros.\n\nEn los últimos años, trabajé en plataformas B2B, widgets embebibles, apps de Shopify, interfaces con IA, constructores de encuestas dinámicos e integraciones de flujo de trabajo en tiempo real. Mi trabajo incluye una plataforma B2B de e-commerce con ~2.000 SKUs, un widget de chatbot de IA conectado a una red de más de 800 clientes de campos de golf, la reescritura de un survey builder entregada en tres semanas, y un portafolio técnico público con ~100 archivos de prueba, 88 problemas de WCAG resueltos, internacionalización en tres idiomas, SEO técnico y conceptos de Clean Architecture/DDD.\n\nApasionado por los entornos orientados al producto, me enfoco en arquitectura, UX y calidad para entregar resultados de impacto.\n\nActualmente en búsqueda de oportunidades internacionales como Ingeniero Frontend, donde pueda contribuir con React/Next.js, TypeScript, arquitectura, visión de producto y ejecución de alta calidad — especialmente en equipos remotos que construyen productos web confiables, escalables y centrados en el usuario.',
      ),
  ...
  const experiences = [
    {
      ...
      description: loc(
        '- Architected and built an embeddable AI chatbot widget using React, Vite, and TypeScript, delivered via script tag to run across client websites without depending on the host application stack.\n- Integrated the AI assistant with backend services to support tee time availability, waitlist flows, and FAQ interactions, contributing to a product used across a network of 800+ golf course clients.\n- Rebuilt a compiled vanilla JavaScript animation system into a state-driven React and Framer Motion implementation for a Shopify app, improving maintainability across multiple buyer offer states.\n- Diagnosed CSS leakage issues across unpredictable Shopify storefront themes and implemented Shadow DOM isolation, reducing integration risk and making the widget more reliable across merchant stores.\n- Contributed across storefront and merchant admin experiences using React, TypeScript, Vite, Shopify Polaris, App Bridge, and Theme App Extensions, helping deliver the MVP within a fixed deadline in a distributed Brazil/US team.',
        '- Arquitetou e construiu um widget de chatbot de IA incorporável usando React, Vite e TypeScript, entregue via script tag para rodar em sites de clientes sem depender do stack da aplicação hospedeira.\n- Integrou o assistente de IA a serviços de backend para suportar disponibilidade de horários, filas de espera e interações de FAQ, contribuindo para um produto usado em uma rede de mais de 800 clientes de campos de golfe.\n- Reconstruiu um sistema de animação em JavaScript vanilla compilado como uma implementação orientada a estado com React e Framer Motion para um app Shopify, melhorando a manutenibilidade em múltiplos estados de oferta ao comprador.\n- Diagnosticou vazamentos de CSS entre temas imprevisíveis de storefronts Shopify e implementou isolamento via Shadow DOM, reduzindo o risco de integração e tornando o widget mais confiável entre lojas de merchants.\n- Contribuiu em experiências de storefront e admin do merchant usando React, TypeScript, Vite, Shopify Polaris, App Bridge e Theme App Extensions, ajudando a entregar o MVP dentro de um prazo fixo em um time distribuído Brasil/EUA.',
        '- Arquitectó y construyó un widget de chatbot de IA embebible usando React, Vite y TypeScript, entregado vía script tag para funcionar en sitios de clientes sin depender del stack de la aplicación anfitriona.\n- Integró el asistente de IA con servicios backend para soportar disponibilidad de horarios, listas de espera e interacciones de FAQ, contribuyendo a un producto usado en una red de más de 800 clientes de campos de golf.\n- Reconstruyó un sistema de animación en JavaScript vanilla compilado como una implementación orientada a estado con React y Framer Motion para una app de Shopify, mejorando la mantenibilidad en múltiples estados de oferta al comprador.\n- Diagnosticó fugas de CSS entre temas impredecibles de storefronts de Shopify e implementó aislamiento con Shadow DOM, reduciendo el riesgo de integración y haciendo el widget más confiable entre tiendas de comerciantes.\n- Contribuyó en experiencias de storefront y admin del comerciante usando React, TypeScript, Vite, Shopify Polaris, App Bridge y Theme App Extensions, ayudando a entregar el MVP dentro de un plazo fijo en un equipo distribuido Brasil/EE.UU.',
      ),
      logoUrl:
    ...
    },
    {
      ...
      location: loc('São Paulo, Brazil', 'São Paulo, Brasil', 'São Paulo, Brasil'),
      description: loc(
        '- Built a full-stack B2B e-commerce platform from greenfield to production using React, TypeScript, Node.js, Express, PostgreSQL, Docker, and AWS, covering both the public institutional website and the private retailer storefront.\n- Designed and implemented a gated B2B access flow with email confirmation, manual retailer approval, and authenticated catalog access, protecting negotiated pricing from public visibility and competitors.\n- Developed a custom B2B pricing engine to calculate customer-specific quotes at request time, supporting more complex commercial rules than a traditional public e-commerce flow.\n- Implemented catalog and quote workflows for approximately 2,000 SKUs across 6 represented brands, including bulk product import, cart, quote generation, order flow, and automatic quote expiration.\n- Deployed a containerized Node.js/PostgreSQL application on AWS, using S3 and CloudFront for product image delivery and Sentry for production monitoring.',
        '- Construiu uma plataforma B2B de e-commerce full-stack do zero à produção usando React, TypeScript, Node.js, Express, PostgreSQL, Docker e AWS, cobrindo tanto o site institucional público quanto a storefront privada para revendedores.\n- Projetou e implementou um fluxo de acesso B2B com confirmação por e-mail, aprovação manual do revendedor e acesso autenticado ao catálogo, protegendo preços negociados de visibilidade pública e concorrentes.\n- Desenvolveu um motor de precificação B2B customizado para calcular orçamentos específicos por cliente no momento da solicitação, suportando regras comerciais mais complexas do que um fluxo tradicional de e-commerce público.\n- Implementou fluxos de catálogo e orçamento para aproximadamente 2.000 SKUs de 6 marcas representadas, incluindo importação em massa de produtos, carrinho, geração de orçamento, fluxo de pedido e expiração automática de orçamentos.\n- Fez o deploy de uma aplicação Node.js/PostgreSQL containerizada na AWS, usando S3 e CloudFront para entrega de imagens de produto e Sentry para monitoramento em produção.',
        '- Construyó una plataforma B2B de e-commerce full-stack desde cero hasta producción usando React, TypeScript, Node.js, Express, PostgreSQL, Docker y AWS, cubriendo tanto el sitio institucional público como el storefront privado para minoristas.\n- Diseñó e implementó un flujo de acceso B2B con confirmación por correo electrónico, aprobación manual del minorista y acceso autenticado al catálogo, protegiendo los precios negociados de la visibilidad pública y de la competencia.\n- Desarrolló un motor de precificación B2B personalizado para calcular cotizaciones específicas por cliente al momento de la solicitud, soportando reglas comerciales más complejas que un flujo tradicional de e-commerce público.\n- Implementó flujos de catálogo y cotización para aproximadamente 2.000 SKUs de 6 marcas representadas, incluyendo importación masiva de productos, carrito, generación de cotizaciones, flujo de pedidos y expiración automática de cotizaciones.\n- Desplegó una aplicación Node.js/PostgreSQL containerizada en AWS, usando S3 y CloudFront para la entrega de imágenes de producto y Sentry para el monitoreo en producción.',
      ),
    ...
    },
    {
      ...
      location: loc('São Paulo, Brazil', 'São Paulo, Brasil', 'São Paulo, Brasil'),
      description: loc(
        '- Owned the full rewrite of a dynamic survey builder from v1 to v2 in three weeks using React, TypeScript, GraphQL, and Material UI, delivering the new version to production within the agreed deadline.\n- Preserved full backward compatibility with legacy survey schemas, allowing existing forms to keep loading correctly without requiring data migration or downstream renderer changes.\n- Redesigned the form state management model to track only the active editing scope instead of keeping the entire form in memory, improving maintainability and performance for complex surveys.\n- Rebuilt the survey creation experience with a simpler and more predictable structure, enabling administrators to configure surveys independently without relying on the original developer.\n- Applied patterns from previous complex form-building experience to balance flexibility, usability, and technical simplicity under a tight delivery window.',
        '- Liderou a reescrita completa de um construtor de pesquisas (survey builder) da v1 para a v2 em três semanas usando React, TypeScript, GraphQL e Material UI, entregando a nova versão em produção dentro do prazo acordado.\n- Preservou total compatibilidade retroativa com schemas legados de pesquisas, permitindo que formulários existentes continuassem carregando corretamente sem exigir migração de dados ou mudanças no renderizador.\n- Redesenhou o modelo de gerenciamento de estado do formulário para rastrear apenas o escopo de edição ativo, em vez de manter todo o formulário em memória, melhorando manutenibilidade e performance em pesquisas complexas.\n- Reconstruiu a experiência de criação de pesquisas com uma estrutura mais simples e previsível, permitindo que administradores configurassem pesquisas de forma independente, sem depender do desenvolvedor original.\n- Aplicou padrões de experiências anteriores com formulários complexos para equilibrar flexibilidade, usabilidade e simplicidade técnica sob um prazo apertado.',
        '- Lideró la reescritura completa de un constructor de encuestas (survey builder) de v1 a v2 en tres semanas usando React, TypeScript, GraphQL y Material UI, entregando la nueva versión a producción dentro del plazo acordado.\n- Preservó total compatibilidad retroactiva con esquemas legados de encuestas, permitiendo que los formularios existentes siguieran cargando correctamente sin requerir migración de datos ni cambios en el renderizador.\n- Rediseñó el modelo de gestión de estado del formulario para rastrear solo el ámbito de edición activo, en lugar de mantener todo el formulario en memoria, mejorando la mantenibilidad y el rendimiento en encuestas complejas.\n- Reconstruyó la experiencia de creación de encuestas con una estructura más simple y predecible, permitiendo a los administradores configurar encuestas de forma independiente, sin depender del desarrollador original.\n- Aplicó patrones de experiencias previas con formularios complejos para equilibrar flexibilidad, usabilidad y simplicidad técnica bajo un plazo de entrega ajustado.',
      ),
      logoUrl:
    ...
    },
    {
      ...
      location: loc('São Paulo, Brazil', 'São Paulo, Brasil', 'São Paulo, Brasil'),
      description: loc(
        '- Contributed to Fieldlink, a workflow-driven platform, by building dynamic custom forms with React, Formik, and JSON schemas, enabling client-specific data collection flows generated and rendered at runtime.\n- Rebuilt a form builder from v1 to v2, supporting nested fields, complex field types, and real-time validation while preserving compatibility with the existing custom forms schema structure.\n- Architected a React MQTT integration library based on a previous JavaScript implementation, abstracting Flow Build framework methods, broker communication, and front-end integration points into a reusable package for client applications.\n- Contributed to the rebuild of a high-impact e-commerce platform that generated millions of BRL in monthly sales, helping define the front-end architecture and build design system components for scalable product interfaces.\n- Mentored junior developers by supporting onboarding, explaining front-end patterns, reviewing implementation approaches, and helping them navigate React, TypeScript, and project-specific architecture.',
        '- Contribuiu para o Fieldlink, uma plataforma orientada a workflows, construindo formulários dinâmicos customizados com React, Formik e JSON schemas, viabilizando fluxos de coleta de dados específicos por cliente, gerados e renderizados em tempo de execução.\n- Reconstruiu um form builder da v1 para a v2, suportando campos aninhados, tipos de campo complexos e validação em tempo real, preservando compatibilidade com a estrutura de schema de formulários existente.\n- Arquitetou uma biblioteca de integração MQTT em React baseada em uma implementação anterior em JavaScript, abstraindo métodos do framework Flow Build, comunicação com broker e pontos de integração frontend em um pacote reutilizável para aplicações de clientes.\n- Contribuiu para a reconstrução de uma plataforma de e-commerce de alto impacto que gerava milhões de reais em vendas mensais, ajudando a definir a arquitetura frontend e construir componentes de design system para interfaces de produto escaláveis.\n- Mentorou desenvolvedores juniores apoiando onboarding, explicando padrões de frontend, revisando abordagens de implementação e ajudando-os a navegar por React, TypeScript e arquitetura específica do projeto.',
        '- Contribuyó a Fieldlink, una plataforma orientada a flujos de trabajo, construyendo formularios dinámicos personalizados con React, Formik y JSON schemas, habilitando flujos de recolección de datos específicos por cliente, generados y renderizados en tiempo de ejecución.\n- Reconstruyó un form builder de v1 a v2, soportando campos anidados, tipos de campo complejos y validación en tiempo real, preservando la compatibilidad con la estructura de esquema de formularios existente.\n- Arquitectó una biblioteca de integración MQTT en React basada en una implementación previa en JavaScript, abstrayendo métodos del framework Flow Build, comunicación con el broker y puntos de integración frontend en un paquete reutilizable para aplicaciones de clientes.\n- Contribuyó a la reconstrucción de una plataforma de e-commerce de alto impacto que generaba millones de reales en ventas mensuales, ayudando a definir la arquitectura frontend y a construir componentes de design system para interfaces de producto escalables.\n- Mentorizó a desarrolladores junior apoyando el onboarding, explicando patrones de frontend, revisando enfoques de implementación y ayudándolos a navegar React, TypeScript y la arquitectura específica del proyecto.',
      ),
      logoUrl:
        'https://daxmkexweadrkobbnuxj.supabase.co/storage/v1/object/public/portfolio-images/site/experiences/fdte_logo.webp',
      logoAlt: loc('FDTE logo', 'Logo da FDTE', 'Logo de FDTE'),
  ...
  const posts = [
    {
      ...
      content: loc(
        'This article explores how chaining domain validation rules through a single Validator instance keeps entity factories readable and error handling predictable.\n\n**Full content coming soon.**',
        'Este artigo explora como encadear regras de validação de domínio através de uma única instância de Validator mantém as factories de entidade legíveis e o tratamento de erro previsível.\n\n**Conteúdo completo em breve.**',
        'Este artículo explora cómo encadenar reglas de validación de dominio a través de una única instancia de Validator mantiene las factories de entidad legibles y el manejo de errores predecible.\n\n**Contenido completo próximamente.**',
      ),
    ...
    },
    {
      ...
      content: loc(
        'This article explains why this portfolio calls use cases directly from Server Components at build time and passes plain data down as props.\n\n**Full content coming soon.**',
        'Este artigo explica por que este portfólio chama use cases diretamente dos Server Components em tempo de build e passa dados puros para baixo como props.\n\n**Conteúdo completo em breve.**',
        'Este artículo explica por qué este portafolio llama a los use cases directamente desde los Server Components en tiempo de build y pasa datos planos hacia abajo como props.\n\n**Contenido completo próximamente.**',
      ),
    ...
    },
    {
      ...
      content: loc(
        'This article demonstrates how the Either pattern handles operation outcomes without exceptions and makes error cases explicit in the type signature.\n\n**Full content coming soon.**',
        'Este artigo demonstra como o Either pattern lida com resultados de operação sem exceções e torna casos de erro explícitos na assinatura de tipo.\n\n**Conteúdo completo em breve.**',
        'Este artículo demuestra cómo el Either pattern maneja resultados de operación sin excepciones y hace casos de error explícitos en la firma de tipo.\n\n**Contenido completo próximamente.**',
      ),
    ...
    },
    {
      ...
      content: loc(
        'This article presents a decision framework for when to encapsulate primitive types in Value Objects versus keeping them as primitives.\n\n**Full content coming soon.**',
        'Este artigo apresenta um framework de decisão para quando encapsular tipos primitivos em Value Objects versus mantê-los como primitivos.\n\n**Conteúdo completo em breve.**',
        'Este artículo presenta un framework de decisión para cuándo encapsular tipos primitivos en Value Objects versus mantenerlos como primitivos.\n\n**Contenido completo próximamente.**',
      ),
