...
export class ProjectMapper {
  ...
  static toPrisma(project: Project): ProjectScalarData {
    return {
      ...
      thumbnailImageUrl: project.thumbnailImage.url.value,
      thumbnailImageAlt: project.thumbnailImage.alt.value,
      title: project.title.value,
      caption: project.caption.value,
      content: project.content.value as object,
      ...
      repositoryUrl: project.repositoryUrl?.value ?? null,
      projectUrl: project.projectUrl?.value ?? null,
