...
apps/
  site/         → Public portfolio + blog (Next.js 16+ App Router)
                  blog lives at src/app/[locale]/blog/** (native routes, no multi-zone)
